            ...
            <div class="card-body">
                <div class="col-md-6">
                    <form action="" method="GET">
                        <input type="hidden" value="laporan-pembelian" name="page">
...
<div class="row mt-3">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Laporan Pembelian <?php echo $titlebulan ?></h4>
            </div>
            <div class="card-body">
                ...
                <a target="_blank" href="page/pembelian/cetak-pembelian.php?bulan=<?= $bulan ?>"
